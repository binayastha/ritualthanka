<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="{{route('frontend.test')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.test')) }}">{{ __('navs.frontend.test') }}</a></li>
            <li class="nav-item"><a href="{{route('frontend.artist.index')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.artist.index ')) }}">{{ __('navs.frontend.artists') }}</a></li>
        </ul>
    </div>
</nav>
