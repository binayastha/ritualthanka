...
@section('content')
    {{ html()->modelForm($artistInfo, 'PATCH', route('admin.artist.artist.update',$artistInfo->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.access.artist.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            @if(!empty($artistInfo->image))
                                <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ URL::to($artistInfo->image) }}">
                            @else
