        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.page.description'))->class('col-md-2 form-control-label')->for('page_content') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.page.photo'))->class('col-md-2 form-control-label')->for('photo') }}
