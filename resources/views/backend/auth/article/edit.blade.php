...
@section('content')
    ...
    {{ html()->modelForm($articleInfo, 'PATCH', route('admin.article.article.update',$articleInfo->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.article.description'))->class('col-md-2 form-control-label')->for('message') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.article.photo'))->class('col-md-2 form-control-label')->for('message') }}
                        ...
                        <div class="col-md-10">
                            <div class="radio">
                                <label>
                                    ...
                                    <?php echo ($articleInfo->status==1) ? 'checked="checked"' : ''; ?>>
                                    Publish
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    ...
                                    <?php echo ($articleInfo->status==0) ? 'checked="checked"' : ''; ?>>
                                    Unpublish
                                </label>
                            </div>
                        </div><!--col-->
